...
- **Lattice diagnostics** quantify the faint organization between detected regions: mean neighbor count, sixfold order, bridge intensity, defect rate, and mean spacing. The optional measured-edge overlay makes the inferred connections visible without treating them as literal bonds.
